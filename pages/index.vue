<template>
  <div>
    ...
    <section class="relative bg-gray-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-20 text-center">
      <div>
        <h2 class="text-3xl leading-tight font-bold">How Cashmacs works?</h2>

        <p class="text-2xl leading-tight mt-2" style="max-width: 900px; margin: 0 auto; margin-top: 1rem;">
          Selling your Mac products is super easy with CashMacs. We have purchased thousands of Apple devices
          from our customers and ready to buy&nbsp;yours.
        </p>
      </div>
      ...
      <div class="flex flex-col md:flex-row items-start justify-between mt-12">
        <div class="w-full bg-white shadow-lg rounded-lg px-4 py-6 lg:p-8 md:mx-2 lg:mx-4">
          <img src="home/icon-home-1.svg" alt="" class="mx-auto h-32">
          <div style="min-height: 108px">
            <h4 class="text-xl font-bold leading-tight mt-8">Selling or Buying?</h4>
            <p class="text-gray-700 mt-2">Tell me where, we'll come check out the Mac!</p>
          </div>
        </div>

        <div class="w-full bg-white shadow-lg rounded-lg px-4 py-6 lg:p-8 md:mx-2 lg:mx-4 mt-4 md:mt-0">
          <img src="home/icon-home-2.svg" alt="" class="mx-auto h-32">
          <div style="min-height: 108px">
            <h4 class="text-xl font-bold leading-tight mt-8">Variables</h4>
            <p class="text-gray-700 mt-2">Tell us the various conditions about the Mac you are selling.</p>
          </div>
        </div>

        <div class="w-full bg-white shadow-lg rounded-lg px-4 py-6 lg:p-8 md:mx-2 lg:mx-4 mt-4 md:mt-0">
          <img src="home/icon-home-3.svg" alt="" class="mx-auto h-32">
          <div style="min-height: 108px">
            <h4 class="text-xl font-bold leading-tight mt-8">Assessment</h4>
            <p class="text-gray-700 mt-2">Our Representative will assess the product in person and give a quote.</p>
          </div>
        </div>
      </div>

      <div class="mt-12 md:mt-20 w-full md:max-w-3xl mx-auto">
        <p class="text-xl">“Cashmac is a no hassle way to get rid of my old mac products after upgrading.  Instant cash in hand on the day of appointment.  Impressive service!”</p>
        <p class="text-xl font-bold text-blue-600 mt-4">Jackie Koche</p>
        <p class="text-sm uppercase tracking-wider text-gray-700">Writer for Happy Day LA</p>
      </div>
    </section>
    ...
    <section class="relative bg-blue-600 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pt-20 pb-40">
      <div class="text-center">
        <h2 class="text-3xl leading-tight font-bold text-white">Have old Macs not being used?</h2>
      </div>
      ...
      <div class="flex flex-col md:flex-row mt-12 items-center justify-between">
        ...
        <div class="w-full md:w-1/2 mt-8 md:mt-0 md:pl-12">
          <h4 class="text-xl font-bold text-white">Turn it into CASH!</h4>
          <p class="text-white leading-snug mt-2">Our representative will drive out to your location and assess your Mac and give you an honest pricing</p>

          <ul class="mt-6 text-white">
            <li>
              <div class="flex items-baseline">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24">
                  <path d="M12 24A12 12 0 0 1 3.515 3.515a12 12 0 0 1 16.971 16.971A11.922 11.922 0 0 1 12 24zm0-23a11 11 0 1 0 11 11A11.014 11.014 0 0 0 12 1zM9.646 16.506a.8.8 0 0 1-.514-.26L5.9 13.016l1.027-1.027 2.723 2.722 7.2-7.252L17.868 8.5l-7.714 7.754a.8.8 0 0 1-.508.252z" fill="#fff"></path></svg>
                <span class="ml-2">Community Backed, Look at our reviews!</span>
              </div>
            </li>
            <li>
              <div class="flex items-baseline">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24">
                  <path d="M12 24A12 12 0 0 1 3.515 3.515a12 12 0 0 1 16.971 16.971A11.922 11.922 0 0 1 12 24zm0-23a11 11 0 1 0 11 11A11.014 11.014 0 0 0 12 1zM9.646 16.506a.8.8 0 0 1-.514-.26L5.9 13.016l1.027-1.027 2.723 2.722 7.2-7.252L17.868 8.5l-7.714 7.754a.8.8 0 0 1-.508.252z" fill="#fff"></path></svg>
                <span class="ml-2">No Hard Feelings if we can't make a deal!</span>
              </div>
            </li>
          </ul>
    ...
    <section class="relative px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 text-center md:text-left -mt-32">
      <div class="flex flex-col md:flex-row items-center justify-between bg-blue-300 px-12 py-10 rounded-lg shadow-lg">
        <div class="w-full md:w-2/3">
          <h2 class="text-3xl leading-tight font-bold">Problems with your Macbook?</h2>
          <p class="mt-2 md:max-w-md">Contact our Tech Support.  We have solutions to most common problems related to Apple devices. </p>
        </div>
